  ...
  return (
    <div>
      <Accordion expanded={expanded === 'panel1'} onChange={(event, isExpanded) => handleChange(isExpanded, 'panel1')}>
        ...
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti exercitationem laboriosam vel est placeat
            fuga assumenda corrupti amet quia, delectus repellat quis praesentium consequatur, dolorem necessitatibus,
            fugit facere veritatis mollitia.
          </Typography>
        </AccordionDetails>
      </Accordion>
